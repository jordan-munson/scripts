...
#pollutants = ['ASO4IJ','ANO3IJ','ANH4IJ', 'AECIJ', 'APOCIJ']
#pollutants = ['ANH4IJ', 'AECIJ']
...
for pollutant in pollutants:
    for year in years:
        inputDir   = '/data/lar/projects/airpact5/saved/'+year+'/' #for AP5 files

        pollutant  = pollutant         # PMIJ or O3
        ...
        outFile   = outDir + simYear + "_" + case + '_NARA_AIRPACT_speciation_benmap_' + pollutant + '_' + metric  + '.csv' # output file name
        ################################################
