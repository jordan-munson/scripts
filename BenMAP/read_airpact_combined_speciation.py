...
inoutputDir    = '/data/lar/projects/airpact5/saved/'
outputDir = '/data/lar/users/jmunson/'
grid_dir = '/data/lar/projects/airpact5/AIRRUN/2018/2018111100/MCIP37/GRIDCRO2D'
# =============================================================================
...
for t in range(0, date_diff):
    print(t)
    # read combined 
    modeloutput= inoutputDir +now.strftime("%Y")+'/'+now.strftime("%m")+"/aconc/combined_" +  now.strftime("%Y%m%d") +".ncf"
...
name = outputDir+'benmap/AP5_'+start.strftime("%Y")+'_'+end.strftime("%Y")+'_PST'
