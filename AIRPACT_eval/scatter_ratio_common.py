...
df_stats = pd.read_csv(r'E:\Research\AIRPACT_eval\stats/aqs_location_stats_common.csv').drop('Unnamed: 0',axis=1)
...
for species in pollutant:
    ...
    ax.scatter(d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-3']['FB [%]'], d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-4']['FB [%]'], s=size, edgecolor='', label='Urban',color = 'grey')
    ax.scatter(d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-3']['FB [%]'], d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-4']['FB [%]'], s=size, edgecolor='', label='Suburban',color = 'orange')
    plt.xlim(xlim)
    plt.ylim(xlim)
    ...
    ax.scatter(d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-4']['FB [%]'], d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-5']['FB [%]'], s=size, edgecolor='', label='Urban',color = 'grey')
    ax.scatter(d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-4']['FB [%]'], d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-5']['FB [%]'], s=size, edgecolor='', label='Suburban',color = 'orange')
    plt.xlim(xlim)
    plt.ylim(xlim)
    plt.plot([-200, 200], [-200, 200], 'k-',linewidth=0.7)
    ...
    ax.scatter(d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-3']['FB [%]'], d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-5']['FB [%]'], s=size, edgecolor='', label=species,color = 'grey')
    ax.scatter(d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-3']['FB [%]'], d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-5']['FB [%]'], s=size, edgecolor='', label=species,color = 'orange')    
    plt.xlim(xlim)
    plt.ylim(xlim)
    plt.plot([-200, 200], [-200, 200], 'k-',linewidth=0.7)
    ...
    ax.scatter(d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-3']['FE [%]'], d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-4']['FE [%]'], s=size, edgecolor='', label='Urban',color = 'grey')
    ax.scatter(d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-3']['FE [%]'], d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-4']['FE [%]'], s=size, edgecolor='', label='Suburban',color = 'orange')    
    plt.xlim(xlimfe)
    plt.ylim(xlimfe)
    plt.plot([-200, 200], [-200, 200], 'k-',linewidth=0.7)
    ...
    ax.scatter(d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-4']['FE [%]'], d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-5']['FE [%]'], s=size, edgecolor='', label='Urban',color = 'grey')
    ax.scatter(d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-4']['FE [%]'], d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-5']['FE [%]'], s=size, edgecolor='', label='Suburban',color = 'orange')    
    plt.xlim(xlimfe)
    plt.xlim(xlimfe)
    plt.ylim(xlimfe)
    plt.plot([-200, 200], [-200, 200], 'k-',linewidth=0.7)
    ...
    ax.scatter(d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-3']['FE [%]'], d.loc[d['SiteType'] == 'URBAN AND CENTER CITY'].loc[d['version'] == 'AP-5']['FE [%]'], s=size, edgecolor='', label=species,color = 'grey')
    ax.scatter(d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-3']['FE [%]'], d.loc[d['SiteType'] == 'SUBURBAN'].loc[d['version'] == 'AP-5']['FE [%]'], s=size, edgecolor='', label=species,color = 'orange')    
    plt.xlim(xlimfe)
    plt.xlim(xlimfe)
    plt.ylim(xlimfe)
    plt.plot([-200, 200], [-200, 200], 'k-',linewidth=0.7)
