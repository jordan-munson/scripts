...
for species in pollutant:
    stats_com = pd.DataFrame(['Forecast Mean', 'Observation Mean', 'MB','ME','FB [%]','FE [%]', "RMSE", "R^2 [-]",'Forecast 98th','Observation 98th'])
    stats_com.index = ['Forecast Mean', 'Observation Mean', 'MB','ME','FB [%]','FE [%]', "RMSE", "R^2 [-]",'Forecast 98th','Observation 98th']
    stats_com = stats_com.drop(0,1)
    print(species)
