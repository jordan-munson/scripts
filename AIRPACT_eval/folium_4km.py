...
folium.raster_layers.ImageOverlay(png2,bounds = extents,name='PM',opacity = 0.5,show = True).add_to(m) #Unchecks the PM layer so that only ozone is seen
...
m.save(output_dir+'folium_4km_ozone_pm_map.html')
m
print('done')
