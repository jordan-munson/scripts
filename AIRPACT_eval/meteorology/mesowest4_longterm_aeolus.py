...
# Read the met data
df1 = pd.read_csv('E:/Research/AIRPACT_eval/meteorology/airpact_met_data/airpact_met_200951_2010818.csv').drop(['Unnamed: 0'],axis=1)
df2 = pd.read_csv('E:/Research/AIRPACT_eval/meteorology/airpact_met_data/airpact_met_201091_201471.csv').drop(['Unnamed: 0','ix','iy'],axis=1)
df3 = pd.read_csv('E:/Research/AIRPACT_eval/meteorology/airpact_met_data/airpact_met_2013326_201471.csv').drop(['Unnamed: 0','ix','iy'],axis=1)
df4 = pd.read_csv('E:/Research/AIRPACT_eval/meteorology/airpact_met_data/airpact_met_201511_20161210.csv').drop(['Unnamed: 0','ix','iy'],axis=1)
df5 = pd.read_csv('E:/Research/AIRPACT_eval/meteorology/airpact_met_data/airpact_met_20161211_201881.csv').drop(['Unnamed: 0','ix','iy'],axis=1)

print('Met data read')

# Combine the met data
df_airpact = pd.concat([df1,df2,df3,df4,df5])
...
'''
grid = 'E:/Research/AIRPACT_eval/meteorology/2009050200/MCIP/GRIDCRO2D'
...
if int(start.strftime('%Y%m%d')) < 20160425:  
    ...
    modeloutputs = 'E:/Research/AIRPACT_eval/meteorology/2009050200/MCIP/METCRO2D'
else:
...
if size < 20000000000:
    df_airpact.to_csv(base_dir +'/airpact_met_'+str(start_year)+str(start_month)+'_'+str(end_year)+str(end_month)+'.csv')   #Theoretically, this file should be about 1.7 GB for all the data
...
#%%
#stations = ['KYKM']    # Use this site for testing to speed up script
...
#        mod_sample1[k] = df_airpact[k][:,iy1,ix1].flatten()
    ...
    # Need these in numeric to do next step
    ...
    df_mod1 = df_airpact.loc[(df_airpact['site_name'] == st_name)]
    ...
    df_models['rh1'] = (df_mod1['Q2'] / ( (pq0 / df_mod1['PRSFC']) * np.exp(a2 * 
                   (df_mod1['TEMP2'] - a3) / (df_mod1['TEMP2'] - a4)) ))*100
    ...
    df_models = df_models.set_index('date_time')  
    ...
    try:    # For some reason Portland, Portland International Airport throws this error "ValueError: Shape of passed values is (16, 103464), indices imply (16, 81096)", so this is my workaround
        ...
        continue
    #df_all = pd.merge(df_h,df_models, on='date_time')
