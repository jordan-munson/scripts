...
df_stats = pd.read_csv(inputdir + '/AQS_stats/aqs_stats_common.csv').drop(['Unnamed: 0','model'],axis=1)
ap3_stats = pd.read_csv(inputdir + '/AQS_stats/aqs_stats_ap3_common.csv').drop(['Unnamed: 0','model'],axis=1)
ap4_stats = pd.read_csv(inputdir + '/AQS_stats/aqs_stats_ap4_common.csv').drop(['Unnamed: 0','model'],axis=1)
ap5_stats = pd.read_csv(inputdir + '/AQS_stats/aqs_stats_ap5_common.csv').drop(['Unnamed: 0','model'],axis=1)
ap_total = pd.read_csv(inputdir + '/AQS_stats/aqs_stats_total_common.csv').drop(['Unnamed: 0'],axis=1)
...
# 
# # Save the plot
# fig.savefig(outputdir + '/airpact_2009-2018_mbme_common.png' ,bbox_inches='tight')
# 
# #%%
# # Plot NMB and NME
# fig, ax = plt.subplots(figsize=(8, 4))
...
# 
# # Save the plot
# fig.savefig(outputdir + '/airpact_2009-2018_nmbnme_common.png' ,bbox_inches='tight')
# #%%
...
# 
# # Save the plot
# fig.savefig(outputdir + '/airpact_versions_nmbnme_common.png' ,bbox_inches='tight')
# =============================================================================
...
# =============================================================================
    ...
    # Save the plot
    fig.savefig(outputdir+'/' +name+ '_'+x+'_airpact_versions_for_paper_common.png' ,bbox_inches='tight')
...
soccer('MB','ME',3,1,0.5,'yes','no','yes','yes','no') # temp,ws,rh # 1.5 was the previous axis max
